...
CollisionData sat_hull_circle   (const ConvexHull &A, const circle     &b);
CollisionData sat_hull_ray      (const ConvexHull &A, const ray        &b);
CollisionData sat_hull_plane    (const ConvexHull &A, const plane      &b);
CollisionData sat_hull_AABB     (const ConvexHull &A, const aabb       &b);
